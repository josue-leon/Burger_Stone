...
class ClientUpdateController {
  ...
  Future init(BuildContext context, Function refresh) async {
    ...
    print('TOKEN ENVIADO: ${usuario.sessionToken}');
    usersProvider.init(context, sessionUser: usuario);
  ...
  void update() async {
    ...
    if (telefono.length > 10) {
      MySnackbar.show(
          context, 'El número telefónico solo puede contener 10 dígitos');
      return;
    }
    ...
    stream.listen((res) async {
      ...
      if (responseApi.success) {
        usuario = await usersProvider
            .getById(myUsuario.id); // Obteniendo el usuario de la bd
