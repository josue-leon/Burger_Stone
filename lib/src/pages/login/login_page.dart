...
class _Login_pageState extends State<Login_page> {
  ...
  LoginController _con =
      new LoginController(); //instanciamos la clase del controlador login

  @override
  void initState() {
    //se ejecuta cuando abrimos el page
  ...
  Widget build(BuildContext context) {
    //metodo que ejecuta todas las vistas codigo q se muestra en la pantalla
    return Scaffold(
        body: Container(
  ...
  Widget _imageBanner() {
    return Container(
      margin: EdgeInsets.only(
          top: 110, bottom: MediaQuery.of(context).size.height * 0.2),
      child: Image.asset(
  ...
  Widget _textDontHaveAccount() {
    return Row(
      ...
      children: [
        ...
        GestureDetector(
          //envuelve a la etiqueta
          onTap: _con
              .goToRegisterPage, //similar al evento onclick cuando el usuario de click llamamos al controlador
          child: Text(
            'Regístrese',
            style: TextStyle(
  ...
  Widget _lottieAnimation() {
    return Container(
        ...
        child: Lottie.asset('assets/json/hamburguer.json',
